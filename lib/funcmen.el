...
(defconst fume-function-name-regexp-sysdul
   "^\\s-*\\(procedure\\|mainprocedure\\|prosedyre\\|hovedprosedyre\\|control-procedure\\|control-mainprocedure\\)\\s-*"
  ...
  (cond ((or fume-function-name-regexp (fume-maybe-install-modeline-feature))
         (save-excursion
           (let ((srcbuffer (current-buffer)))
             ...
             (local-set-key "q" 'fume-list-functions-quit)
             (local-set-key "h" 'fume-list-functions-help)
             (local-set-key "?" 'fume-list-functions-help)
             (local-set-key "g" 'fume-prompt-function-goto)
             (local-set-key "G" 'fume-prompt-function-goto-one-window)
             (local-set-key "o" 'fume-prompt-function-goto-other-window)
