...
;;   Created: June 1994
;;   Last modified: 1997/06/26 08:40:04
;;   Version: 2.26
...
;; 1997/06/26 08:40:04|2.26|~/misc/mode-compile.el.Z|
;;
...
;; ===========
;;
;;   Some debug with remote pathname stuff.
;;   No more error when buffer has no file-name (dired, compilation ...)
;;
...
;;;###autoload
(defconst mode-compile-version "2.26"
  "Current version of mode-compile package.
 
mode-compile.el,v 2.26 1997/06/26 08:40:04 boubaker Exp
...
(defun mode-compile-submit-bug-report ()
  "*Submit via mail a bug report on mode-compile v2.26."
  (interactive)
  (and
