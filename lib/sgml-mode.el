...
(defcustom sgml-font-lock-keywords-3 ()
  "*Local font-lock keywords."
  :type 'list
  :group 'sgml)
...
varables of same name)."
  ...
  (make-local-variable 'sgml-font-lock-keywords-3)
...
\\{sgml-mode-map}"
  ...
  (setq imenu-generic-expression '((nil "<!\\(element\\|entity\\)[ 	\n]+%?[ 	\n]*\\([A-Za-z][-A-Za-z.0-9]*\\)" 2)))
