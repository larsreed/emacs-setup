...
(defvar sgml-mode-hook nil
  "Hooks to run when entering true sgml-mode.")
(defvar html-mode-hook nil
  "Hooks to run when entering true html-mode.")
(defvar sgml-mode-common-hook nil
  "Hooks to run when entering sgml-mode based modes.")
...
^</?\\([A-Za-z]\\([-.A-Za-z0-9= \t\n]\\|\"[^\"]*\"\\|'[^']*'\\)*\\)?>$"
  ...
  (run-hooks 'text-mode-hook 'sgml-mode-common-hook))
