...
public class NodeSetExtent extends NodeSetValue implements org.w3c.dom.NodeList {
    ...
    */
    ...
    public NodeSetExtent(NodeEnumeration enum) throws SAXException {
        int size;
        ...
        while (enum.hasMoreElements()) {
            ...
            value[i++] = enum.nextElement();
        }
        sorted = enum.isSorted() || i<2;
        reverseSorted = enum.isReverseSorted() || i<2;
        length = i;
    }
    ...
    */
    ...
    public NodeSetValue sort() throws SAXException {
        ...
        if (reverseSorted) {
            ...
            NodeEnumeration enum = enumerate();
