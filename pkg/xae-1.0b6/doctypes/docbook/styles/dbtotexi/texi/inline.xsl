...
<!-- ********************************************************************
     $Id: inline.xsl,v 1.10 2000/08/21 22:52:45 stevecheng Exp $
     ********************************************************************
...
<xsl:template name="inline.romanseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.superscriptseq">
  ...
  <!-- FIXME: We need to escape certain chars 
       for serious usage but I don't know the TeX. -->
  <math><xsl:text>^</xsl:text><xsl:copy-of select="$content"/></math>
</xsl:template>
...
<xsl:template name="inline.subscriptseq">
  ...
  <math><xsl:text>_</xsl:text><xsl:copy-of select="$content"/></math>
</xsl:template>
...
<xsl:template name="inline.codeseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.sampseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.citeseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.emailseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.dfnseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.fileseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.scseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.acronymseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.emphseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.strongseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.keyseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.kbdseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template name="inline.varseq">
  <xsl:param name="content">
    <xsl:apply-templates/>
  </xsl:param>
...
<xsl:template match="accel">
  <xsl:call-template name="inline.kbdseq"/>
</xsl:template>
...
<xsl:template match="classname">
  <xsl:call-template name="inline.codeseq"/>
</xsl:template>
...
<xsl:template match="computeroutput">
  <xsl:call-template name="inline.sampseq"/>
</xsl:template>
...
<xsl:template match="filename">
  <xsl:call-template name="inline.fileseq"/>
</xsl:template>

<!-- CHECKME: clash with manvolnum? -->
<xsl:template match="refentrytitle/function" priority="1">
  <xsl:call-template name="inline.charseq" />
</xsl:template>
...
<xsl:template match="keycap">
  <xsl:call-template name="inline.keyseq"/>
</xsl:template>
...
<xsl:template match="replaceable">
  <xsl:call-template name="inline.varseq"/>
</xsl:template>
...
<xsl:template match="acronym">
  <xsl:call-template name="inline.acronymseq"/>
</xsl:template>
...
<xsl:template match="emphasis">
  <xsl:choose>
    <xsl:when test="@role='strong' or @role='bold' or parent::emphasis">
      <xsl:call-template name="inline.strongseq"/>
    </xsl:when>
    <xsl:otherwise>
      <xsl:call-template name="inline.emphseq" />
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template match="quote">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <xsl:call-template name="gentext.char">
        <xsl:with-param name="key" select="'nestedquote.start'" />
      </xsl:call-template>
      <xsl:call-template name="inline.charseq"/>
      <xsl:call-template name="gentext.char">
        <xsl:with-param name="key" select="'nestedquote.end'" />
      </xsl:call-template>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template match="email">
  <xsl:call-template name="inline.emailseq" />
</xsl:template>
  ...
  <xsl:if test="$show.comments">
    <i>
      <xsl:call-template name="gentext.element">
        <xsl:with-param name="element.name" select="'remark'" />
      </xsl:call-template>
    </i>
  </xsl:if>
</xsl:template>

<xsl:template match="gt:element[@name='remark']/gt:content"
              mode="gentext.mode">
  <xsl:param name="node" />
