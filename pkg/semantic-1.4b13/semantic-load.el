...
;; [LRE] (add-hook 'c-mode-hook 'semantic-default-c-setup)
;; [LRE] (add-hook 'c++-mode-hook 'semantic-default-c-setup)

(autoload 'semantic-default-elisp-setup "semantic-el")
;; [LRE] (add-hook 'emacs-lisp-mode-hook 'semantic-default-elisp-setup)
...
;; [LRE] (add-hook 'makefile-mode-hook 'semantic-default-make-setup)

(autoload 'semantic-default-texi-setup "semantic-texi")
;; [LRE] (add-hook 'texinfo-mode-hook 'semantic-default-texi-setup)
