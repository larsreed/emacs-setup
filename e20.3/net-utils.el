...
;; Time-stamp: <1998-10-03 21:54:54 pbreton>
...
variable.  If whois-guess-server is non-nil then try to deduce the
correct server from SEARCH-STRING. With argument, prompt for whois
server."
  (interactive "P\nsWhois: ")
